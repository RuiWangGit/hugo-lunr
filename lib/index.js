...
HugoLunr.prototype.readFile = function(filePath){
	...
	var item = {'uri' : uri , 'title' : meta.data.title, 'content':plainText, 'tags':tags, 'location':meta.data.location || "", 'cohort':meta.data.cohort || "", 'job':meta.data.job || "", 'href':meta.data.href || "" };
	self.list.push(item);
}
